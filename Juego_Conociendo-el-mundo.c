...
int cambiaPuntos(int ch)/*Función que lleva el control de puntos de los jugadores según ciertas circunstancias*/
{
    int puntos=0;
    switch (ch)
    {
        case 0:printf("¡Felicidades has ganado 10 puntos\n");
                puntos=puntos+10;break;
        case 1:printf("¡Qué mala suerte no has podido adivinar así que pierdes 4 puntos!\n");
